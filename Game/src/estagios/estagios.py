import pygame
from src.components.sprite import sprites, Sprite       # Importamos a nossa Classe Sprite e uma lista com as sprites ativas no jogo
from src.components.player import Player                # ´´ a nossa Classe Jogador
from src.components.entity import Entity, active_objs   # ´´ a Classe Entity e uma lista de objetos ativos no jogo
from src.components.physics import Body, reset_bodies   # ´´ a Classe do corpo e uma função para resetá-los
from src.core.input import keys_down                    # ´´ a função de identificar teclas apertadas
from src.core.map import Map, TileKind, Key             # ´´ a Classe do mapa, a classe dos blocos do jogo e a classe da chave
from src.core.camera import create_screen, camera       # ´´ a função de criar tela e a Classe camera
from src.core.lanterna import Lanterna                  # ´´ a Classe Lanterna 
from src.components.label import labels                 # ´´ uma lista com os escritos do jogo
from src.core.area import area, Area                    # ´´ a Classe Area e a variavel que vai receber o arquivo do mapa
from src.components.enemy import Enemy                  # ´´ a Classe do Fantasma
from src.data.objects import entity_factories           # ´´ a lista com os objetos do jogo
from src.components.menu import *                       # ´´ o Menu do jogo e as imagens das telas
from src.core.sons import *                             # ´´ todos os sons do jogo
...
# Configurações gerais
    ...
    tile_kinds = [ 
        TileKind("dirt", "content/images/dirt.png", False),      # 0 no mapa
        TileKind("grass", "content/images/grass.png", False),    # 1 no mapa
        TileKind("water", "content/images/water.png", True),     # 2 no mapa
        TileKind("wood", "content/images/madeira.png", False),   # 3 no mapa
        TileKind("gravel", "content/images/gravel.png", False)   # 4 no mapa
    ]
    ...
    key_image = pygame.image.load("content/images/chave.png")  
    chave = Key(4042, 1499, image=key_image)
    casa = Entity(Sprite("content/images/casa.png"), Body(-32,32,200,200), x=10, y=-80)
