...
from src.components.entity import active_objs, Entity
from src.core.input import is_key_pressed
from src.core.camera import camera
from src.components.label import Label
import math
from src.core.sons import som_passo
...
class Player:
    def __init__(self):
        ...
        self.load_sprites("content/images/spritesheet.png")  # Spritesheet carregado
